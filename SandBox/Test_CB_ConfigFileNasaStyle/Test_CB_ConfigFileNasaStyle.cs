                ...
                foreach (string line in lines)
                {
                    ...
                    else
                    {
                        if(treeModels != null)
                        {
                            ...
                            else if(line.Contains("!"))
                            {
                                ...
                                if(textPropertyBuf.Length == 2)
                                {
                                    ...
                                    if (textPropertyBuf[1].Trim().Equals(propertyInfo.Desription.Trim()))
                                    {
                                        ...
                                        {
                                            Console.WriteLine(string.Format("LoadFile propertyInfo type length error {0}", propertyInfo.Types.Length));
                                        }
                            ...
                            {
                                Console.WriteLine("LoadFile not found any reserved character");
                            }
                        }
                        else
                        {
            ...
            try
            {
                ...
                foreach (var item in data)
                {
                    if (item.PIndex == -1)
                    {
                        ...
                        {
                            Console.WriteLine(string.Format("SaveFile item.Values.Length error {0},{1},{2}", item.SIndex, item.PIndex, item.Values.Length));
                        }
                    }
                    ...
                    {
                        Console.WriteLine(string.Format("SaveFile PIndex error {0},{1},{2}", item.SIndex, item.PIndex, item.Desription));
                    }
